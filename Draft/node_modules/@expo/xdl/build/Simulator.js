...
function _BundleIdentifier() {
  const data = require("./BundleIdentifier");
...
async function openUrlInSimulatorSafeAsync({
  ...
  try {
    if (devClient) {
      const bundleIdentifier = await (0, _BundleIdentifier().configureBundleIdentifierAsync)(projectRoot, exp);
